...
class API {
	...
	public function __construct($host, $db, $table, $username, $password){
		...
		if(!Database::init_connection($host, $db, $table, $username, $password)){
			...
			$json_obj->config_errors[] = "database connection failed, make sure the connection information passed into API::__construct(\$host, \$db, \$table, \$username, \$password) is correct";
