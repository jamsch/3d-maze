function CharacterController(scene, camera, position) {
	...
	setInterval(function() {
		console.log("Position: x:" + self.body.position.x + ", z: " + self.body.position.z);
	},3000)
	*/
}
...
CharacterController.prototype.update = function(delta) {
	...
	if (!collisions || (this.flyEnabled && this.getY() > this.blockSize)) { //|| this._allowMovement(move, collisions)
        ...
        this.body.position = this.previousPosition;
	}
};
